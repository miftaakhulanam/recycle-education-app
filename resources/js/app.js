  ...
  \**********************************************/
            ...
            /***/ function (module, exports, __webpack_require__) {
                (function (global, factory) {
                    ...
                    function saferEvalNoReturn(
                        ...
                        return tryCatch(
                            () => {
                                ...
                                if (
                                    Object.keys(dataContext).includes(
                                        expression
                                    )
                                ) {
                    ...
                    function isXAttr(attr) {
                        const name = replaceAtAndColonWithStandardSyntax(
                            attr.name
                        );
                    ...
                    function parseHtmlAttribute({ name, value }) {
                        const normalizedName =
                            replaceAtAndColonWithStandardSyntax(name);
                        const typeMatch = normalizedName.match(xAttrRE);
                        const valueMatch =
                            normalizedName.match(/:([a-zA-Z0-9\-:]+)/);
                        const modifiers =
                    ...
                    function convertClassStringToArray(
                        classList,
                        filterFn = Boolean
                    ) {
                    ...
                    function transitionIn(
                        ...
                        if (
                            showAttr &&
                            showAttr.modifiers.includes("transition")
                        ) {
                            ...
                            const settingBothSidesOfTransition =
                                modifiers.includes("in") &&
                                modifiers.includes("out"); // If x-show.transition.in...out... only use "in" related modifiers for this transition.
                    ...
                    function transitionHelper(
                        ...
                        const transitionScale =
                            noModifiers || modifiers.includes("scale"); // These are the explicit stages of a transition (same stages for in and for out).
                    ...
                    function handleForDirective(
                        ...
                        items.forEach((item, index) => {
                            ...
                            if (!nextEl) {
                                nextEl = addElementInLoopAfterCurrentEl(
                                    templateEl,
                                    currentEl
                    ...
                    function generateKeyForIteration(
                        ...
                        let bindKeyAttribute = getXAttrs(
                            el,
                            component,
                            "bind"
                        ).filter((attr) => attr.value === "key")[0]; // If the dev hasn't specified a key, just return the index of the iteration.
                    ...
                    function addElementInLoopAfterCurrentEl(
                        templateEl,
                        currentEl
                    ) {
                    ...
                    function lookAheadForMatchingKeyedElementAndMoveItIfFound(
                        ...
                        while (tmpNextEl) {
                            if (tmpNextEl.__x_for_key === currentKey) {
                                return tmpNextEl.parentElement.insertBefore(
                                    tmpNextEl,
                                    nextEl
                                );
                            }
                            ...
                            tmpNextEl =
                                ...
                                tmpNextEl.nextElementSibling.__x_for_key !==
                                    undefined
                                    ? tmpNextEl.nextElementSibling
                                    : false;
                        }
                    ...
                    function removeAnyLeftOverElementsFromPreviousUpdate(
                        ...
                        var nextElementFromOldLoop =
                            currentEl.nextElementSibling &&
                            currentEl.nextElementSibling.__x_for_key !==
                                undefined
                                ? currentEl.nextElementSibling
                                : false;

                        while (nextElementFromOldLoop) {
                            let nextElementFromOldLoopImmutable =
                                nextElementFromOldLoop;
                            let nextSibling =
                                nextElementFromOldLoop.nextElementSibling;
                            transitionOut(
                                nextElementFromOldLoop,
                                () => {
                            ...
                            nextElementFromOldLoop =
                                nextSibling &&
                                nextSibling.__x_for_key !== undefined
                                    ? nextSibling
                                    : false;
                        }
                    }
                        ...
                        if (attrName === "value") {
                            ...
                            if (Array.isArray(value)) {
                                const originalClasses =
                                    el.__x_original_classes || [];
                                el.setAttribute(
                                    "class",
                                    arrayUnique(
                                        originalClasses.concat(value)
                                    ).join(" ")
                                );
                            } else if (typeof value === "object") {
                                // Sorting the keys / class names by their boolean value will ensure that
                                // anything that evaluates to `false` and needs to remove classes is run first.
                                const keysSortedByBooleanValue = Object.keys(
                                    value
                                ...
                                el.setAttribute(
                                    "class",
                                    arrayUnique(
                                        originalClasses.concat(newClasses)
                                    ).join(" ")
                                );
                            }
                        } else {
                    ...
                    function generateModelAssignmentFunction(
                        el,
                        modifiers,
                        expression
                    ) {
                        ...
                        return (event, currentValue) => {
                            ...
                            if (event instanceof CustomEvent && event.detail) {
                                ...
                                if (Array.isArray(currentValue)) {
                                    const newValue = modifiers.includes(
                                        "number"
                                    )
                    ...
                    class ReactiveProxyHandler {
                        ...
                        isExtensible(shadowTarget) {
                            const shadowIsExtensible =
                                isExtensible(shadowTarget);
                            if (!shadowIsExtensible) {
                                return shadowIsExtensible;
                            }
                            const { originalTarget, membrane } = this;
                            const targetIsExtensible =
                                isExtensible(originalTarget);
                        ...
                        getOwnPropertyDescriptor(shadowTarget, key) {
                            ...
                            valueObserved(originalTarget, key);
                            let desc = getOwnPropertyDescriptor(
                                originalTarget,
                                key
                            );
                            if (isUndefined(desc)) {
                    ...
                    class ReactiveMembrane {
                        constructor(options) {
                            ...
                            if (!isUndefined(options)) {
                                ...
                                this.valueDistortion = isFunction(
                                    valueDistortion
                                )
                                    ? valueDistortion
                                ...
                                this.valueIsObservable = isFunction(
                                    valueIsObservable
                                )
                                    ? valueIsObservable
                        ...
                        getProxy(value) {
                            ...
                            const distorted =
                                this.valueDistortion(unwrappedValue);
                            if (this.valueIsObservable(distorted)) {
                                const o = this.getReactiveState(
                                    unwrappedValue,
                                    distorted
                                );
                        ...
                        getReadOnlyProxy(value) {
                            ...
                            if (this.valueIsObservable(distorted)) {
                                return this.getReactiveState(value, distorted)
                                    .readOnly;
                            }
                            return distorted;
                        }
                    ...
                    class Component {
                        constructor(el, componentForClone = null) {
                            ...
                            const initExpression =
                                this.$el.getAttribute("x-init");
                            let dataExtras = {
                                $el: this.$el,
                            };
                            let canonicalComponentElementReference =
                                componentForClone
                            ...
                            return wrap(data, (target, key) => {
                                if (self.watchers[key]) {
                                    ...
                                    Object.keys(self.watchers).forEach(
                                        (fullDotNotationKey) => {
                                            let dotNotationParts =
                                                fullDotNotationKey.split("."); // Ignore length mutations since they would result in duplicate calls.
                                    ...
                                    Object.keys(self.watchers)
                                        ...
                                        .forEach((fullDotNotationKey) => {
                                            let dotNotationParts =
                                                fullDotNotationKey.split("."); // If this dot-notation watcher's last "part" doesn't match the current
                                            // key, then skip it early for performance reasons.

                                            if (
                                                key !==
                                                dotNotationParts[
                                                    dotNotationParts.length - 1
                                                ]
                                            )
                                    ...
                                    for (let i = 0; i < mutations.length; i++) {
                                        ...
                                        if (
                                            !(
                                                ...
                                                closestParentComponent.isSameNode(
                                                    this.$el
                                                )
                                            )
                                        )
                    ...
                    const Alpine = {
                        ...
                        discoverUninitializedComponents:
                            function discoverUninitializedComponents(
                                callback,
                                el = null
                            ) {
                                const rootEls = (
                        ...
                        addMagicProperty: function addMagicProperty(
                            name,
                            callback
                        ) {
                            this.magicProperties[name] = callback;
                        },
                        onComponentInitialized: function onComponentInitialized(
                            callback
                        ) {
                            this.onComponentInitializeds.push(callback);
                        },
                        onBeforeComponentInitialized:
                            function onBeforeComponentInitialized(callback) {
                                this.onBeforeComponentInitializeds.push(
                                    callback
                                );
                            },
                    };
       ...
       \***********************************/
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                /* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(
                        /*! alpinejs */ "./node_modules/alpinejs/dist/alpine.js"
                    );
                /* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_0___default =
       ...
       \***********************************************************************/
            ...
            /***/ function (module, exports, __webpack_require__) {
                __webpack_require__(
                    /*! C:\Users\asus\Desktop\dashboard\dashboard\source\_assets\js\main.js */ "./source/_assets/js/main.js"
                );
                module.exports = __webpack_require__(
                    /*! C:\Users\asus\Desktop\dashboard\dashboard\source\_assets\css\main.css */ "./source/_assets/css/main.css"
                );
